...
class SourceCPYZJ:
    ...
    def get_data(self):
        ...
        url = 'https://www.cpyzj.com/open-awards-detail.html?lotCode=10009&lotGroupCode=4'
        ...
        try:
            ...
            issues = []
            codes = []
            trs = browser.find_elements_by_css_selector('#openNirList tr')
            ...
            for tr in trs:
                ...
                for td in tds:
                    ...
                    if index == 1:
                        issues.append(td.get_attribute('innerHTML'))
                    if index == 2:
                        code = []
                        spans = td.find_elements_by_tag_name('span')
                        for span in spans:
                            code.append(span.get_attribute('innerHTML'))
